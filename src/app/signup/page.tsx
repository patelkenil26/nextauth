...
export default function SignupPage() {
  ...
  return (
    <div className='flex flex-col items-center justify-center py-2 min-h-screen'>
      ...
      <input className='p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600  ' type="text" value={user.username} id='username' placeholder='username' onChange={(e)=>setUser({...user,username:e.target.value})}/>
